...
func _tweented():
	...
	$M2/BG/M/VB/Title/InvLabel.percent_visible = 0
	...
	t.interpolate_property($M2/BG/M/VB/Title/InvLabel, "percent_visible", null, 1, 0.25, Tween.TRANS_LINEAR, Tween.EASE_IN)
	t.start()
